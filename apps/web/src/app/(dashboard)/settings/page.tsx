...
export default function SettingsPage() {
  return (
    <div>
      ...
      <section className="grid-2"><Card><h2>Security</h2><div className="timeline"><div className="timeline-item"><strong>Firebase Authentication</strong><Pill tone="green">Enabled</Pill></div><div className="timeline-item"><strong>JWT Sessions</strong><Pill tone="green">Enabled</Pill></div><div className="timeline-item"><strong>Tenant Guard</strong><Pill tone="green">Enabled</Pill></div></div></Card><Card><h2>Preferences</h2><p>Dark mode, dashboard layout, and notification routing will live here.</p></Card></section>
    </div>
  );
}